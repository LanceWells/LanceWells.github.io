...
export const CarpetMaps: CarpetMap[] = [
    new CarpetMap("Simple Weapons", "url(/images/Item_Shop/Items/Rugs/purplerug.png)", "Weapon", ["Club", "Dagger", "Greatclub", "Handaxe", "Javelin", "LightHammer", "SnakeStaff", "Quarterstaff"]),
